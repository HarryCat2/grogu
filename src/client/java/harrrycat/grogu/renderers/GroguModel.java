...
public class GroguModel extends EntityModel<EntityRenderState>
{
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData legs = modelPartData.addChild("legs", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -2.75F, -2.15F, 5.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 23.75F, 0.15F));

		ModelPartData torso = legs.addChild("torso", ModelPartBuilder.create().uv(0, 13).cuboid(-2.25F, -2.5F, -1.6F, 4.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.25F, -3.25F, 0.0F));
